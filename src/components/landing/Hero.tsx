...
function MagneticButton() {
  ...
  return (
    <motion.a
      ...
      className="mt-10 inline-flex animate-[ringPulse_3.2s_ease-in-out_infinite] items-center gap-2 rounded-full bg-gradient-brand px-8 py-[15px] text-[15px] font-semibold text-ink no-underline shadow-[0_0_0_1px_rgba(255,255,255,0.06),0_20px_50px_-12px_rgba(217,70,239,0.4)] transition-shadow duration-250 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_26px_60px_-10px_rgba(217,70,239,0.55)]"
    >
      Смотреть картины
    </motion.a>
  );
